...
mesh_solver = uw.systems.Poisson(init_mesh, u_Field=Rmesh, solver_name="Remesh_solver")
...
class FreeSurfaceProcessor_Annulus(object): 
    def __init__(self,mesh,v,dt):
        ...
        self.mesh_solver = uw.systems.Poisson(self.init_mesh , u_Field=self.Rmesh, solver_name="FreeSurf_solver")
