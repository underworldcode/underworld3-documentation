...
stokes = uw.systems.Stokes(terrain_mesh, v, p)
...
nbc = 10000 *  sympy.Matrix(sympy.simplify( 
...
if uw.mpi.size == 1:
    ...
    pl.add_mesh(pvstream2, opacity=0.5, show_scalar_bar=False
)
    ...
    # pl.screenshot(filename="channel.png", window_size=(1000, 1000), return_img=False)
    # OR
