...
# ! ls -trl ~/+Simulations/ChannelFlow/ChannelFlow3D


# %%
checkpoint_dir = "~/+Simulations/ChannelFlow/ChannelFlow3D"
checkpoint_base = f"WigglyBottom_7"
...
v_soln_ckpt = uw.discretisation.MeshVariable("V7", terrain_mesh, terrain_mesh.dim, degree=2)
p_soln_ckpt = uw.discretisation.MeshVariable("P7", terrain_mesh, 1, degree=1)

v_soln_ckpt.read_timestep(checkpoint_base, "V7", step, outputPath=checkpoint_dir)
p_soln_ckpt.read_timestep(checkpoint_base, "P7", step, outputPath=checkpoint_dir)
