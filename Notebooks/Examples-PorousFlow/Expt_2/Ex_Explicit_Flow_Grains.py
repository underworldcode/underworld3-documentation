...
stokes.add_natural_bc(10000 * v_soln.sym.dot(GammaN) * GammaN, "inclusion")
...
# ! cp Ex_Explicit_Flow_Grains.py Expt_2
import os
...
for step in range(0, int(0.1/dt)):
...
pl.screenshot(window_size=(2000,500), filename="Expt_2.1.5599.png")
pass
